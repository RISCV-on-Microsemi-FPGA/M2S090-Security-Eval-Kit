...
create_generated_clock -name {FIC_0_CLK} -multiply_by 249 -divide_by 150 -source [ get_pins { uncore/MSS_SUBSYSTEM_sb_0/CCC_0/CCC_INST/CLK0_PAD } ] -phase 0 [ get_pins { uncore/MSS_SUBSYSTEM_sb_0/CCC_0/CCC_INST/GL0 } ]
...
create_clock -name {TCK} -period $TCK_PERIOD [get_ports { TCK } ]
